add wave -noupdate -divider {nios_old_nios2_qsys_0: top-level ports}
...
add wave -noupdate -divider {nios_old_nios2_qsys_0: common}
...
add wave -noupdate -divider {nios_old_nios2_qsys_0: breaks}
